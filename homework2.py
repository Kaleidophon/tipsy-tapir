...
if __name__ == "__main__":
    ...
    del tf_C, query_terms_inverted, unique_terms_per_document, query_word_positions, document_length
    ...
    doc_representations = load_document_representations("./win_representations_5_7")
